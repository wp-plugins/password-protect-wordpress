...
$thePlugin->_settings()
	...
	->addSetting( "unprotect_certain_pages" )
		...
		->setType( "checkbox" )
		->setDefault( "off" )
		->setHelp( __( "When enabled, the pages with the IDs listed will not be protected - enter as a comma delimited list.", $pluginSlug ) )
		->addTag( 'is-premium' )
		->settingToggle( "pages_to_unprotect")
	->addSetting( "pages_to_unprotect" )
		->setName( __( "IDs of pages/posts to not protect", $pluginSlug ) )
		->setType( "text" )
		->setDefault( "" )
